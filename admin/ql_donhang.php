...
<table class="table table-bordered" style="text-align: center;">
    ...
    <table style="background-color: #fff;">
        <tr class='tieude_hienthi_sp' >  
            <td>STT</td>
            <td>Mã đơn hàng</td>
            <td stype="width: 30%;">Tên khách hàng</td>
            <td>Điện thoại</td>
            <td>Email</td>
            <td>Trạng thái</td>
            <td>Xác nhận</td>
        ...
        <?php 
        // nếu đã có số thứ tự của trang thì giữ nguên (ở đây tôi dùng biến $page)   stype="width: 50%;text-align: center;"
        ...
        <form action="index.php?admin=xulyhd&madh=<?php echo $bien['idhd']; ?>" method="post">
                ...
                <td style="width:70px;"><a href="index.php?admin=chitiethoadon&madh=<?php echo $bien['idhd']; ?> " style="float:left;" class="btn btn-danger">Chi tiết</a>	
                </td>
			</form>  
        </tr>
        <?php 
