...
<body>
    <table class="table table-bordered">
        <h3 style="text-align: center;  margin-bottom:30px; font-size: 35px; font-weight:bold;">Danh mục sản phẩm</h3>
        <tr>
            <td colspan="5"><a href="./index.php?admin=addsanpham"><button class="btn btn-primary" style=" margin-left:860px;">Thêm mới</button></a></td>
        </tr>
